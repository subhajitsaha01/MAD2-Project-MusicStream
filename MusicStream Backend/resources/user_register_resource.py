...
from utilities.user_utilities import email_exists, username_exists, insert_general_user
...
class UserRegistrationApi(Resource):
    ...
    def post(self):
        ...
        if email_exists(email) or username_exists(username):
            ...
            insert_general_user(username=username,email=email,password=password)
            return {"message":"General User is created"}, 201
    def delete(self):
        pass